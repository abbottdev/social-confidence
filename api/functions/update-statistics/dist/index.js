...
(function() {
  ...
  ref1 = __webpack_require__(4), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        NodeType = __webpack_require__(1);
        XMLNodeList = __webpack_require__(172);
        XMLNamedNodeMap = __webpack_require__(11);
        DocumentPosition = __webpack_require__(173);
      }
    }
...
(function() {
  ...
  ref = __webpack_require__(4), isObject = ref.isObject, isFunction = ref.isFunction, getValue = ref.getValue;

  XMLNode = __webpack_require__(3);

  NodeType = __webpack_require__(1);

  XMLAttribute = __webpack_require__(28);
...
(function() {
  ...
  XMLCharacterData = __webpack_require__(6);
...
(function() {
  ...
  XMLDOMImplementation = __webpack_require__(26);

  XMLDOMConfiguration = __webpack_require__(169);
...
(function() {
  ...
  assign = __webpack_require__(4).assign;
  ...
  WriterState = __webpack_require__(7);
...
Object.defineProperty(exports, "__esModule", { value: true });
const handler_1 = __webpack_require__(162);
...
Object.defineProperty(exports, "__esModule", { value: true });
const node_fetch_1 = __importDefault(__webpack_require__(163));
const lodash_merge_1 = __importDefault(__webpack_require__(164));
const AWS = __importStar(__webpack_require__(165));
const xmlJs = __importStar(__webpack_require__(166));
...
class StatisticsHandler {
    ...
    getLatestStatisticsUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response && response.ok) {
                ...
                const sortedBlobs = allBlobs.sort((a, b) => moment_1.default(a.Properties[0]["Last-Modified"][0]).valueOf() - moment_1.default(b.Properties[0]["Last-Modified"][0]).valueOf());
    ...
    momentEqual(firstDate, secondDate) {
        return moment_1.default(firstDate).isSame(moment_1.default(secondDate), "date");
    }
    getGbStatistics() {
        return __awaiter(this, void 0, void 0, function* () {
            debugger;
            ...
            if (url) {
                ...
                if (response && response.ok) {
                    ...
                    previousConfirmedCases = previousConfirmedCases.sort((a, b) => moment_1.default(a.reportDate).valueOf() - moment_1.default(b.reportDate).valueOf());
                    previousConfirmedDeaths = previousConfirmedDeaths.sort((a, b) => moment_1.default(a.reportDate).valueOf() - moment_1.default(b.reportDate).valueOf());
...
function FindPrevious(previousConfirmedCases, itemToFind) {
    let previous = previousConfirmedCases.find(pcc => moment_1.default(pcc.reportDate).isSame(moment_1.default(itemToFind.date), "date"));
    if (previous == undefined) {
        previous = { change: 0, cumulative: 0, reportDate: moment_1.default(itemToFind.date).toJSON() };
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(160);
...
(function() {
  ...
  processors = __webpack_require__(32);
...
(function() {
  ...
  builder = __webpack_require__(168);

  defaults = __webpack_require__(9).defaults;
...
(function() {
  ...
  XMLDocument = __webpack_require__(27);

  XMLDocumentCB = __webpack_require__(174);

  XMLStringWriter = __webpack_require__(23);

  XMLStreamWriter = __webpack_require__(175);
...
(function() {
  ...
  XMLDOMErrorHandler = __webpack_require__(170);

  XMLDOMStringList = __webpack_require__(171);
...
(function() {
  ...
  ref = __webpack_require__(4), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, getValue = ref.getValue;
...
(function() {
  ...
  sax = __webpack_require__(177);

  events = __webpack_require__(179);

  bom = __webpack_require__(180);
...
;(function (sax) { // wrapper for non-node envs
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(178).StringDecoder
